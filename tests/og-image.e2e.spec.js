...
test.describe('OpenGraph Image Validation', () => {
  const ogImagePath = path.join(process.cwd(), 'src', 'img', 'UI', 'og-share.png');

  test('og-share.png should exist', async () => {
    expect(fs.existsSync(ogImagePath), 'El archivo src/img/UI/og-share.png no existe').toBeTruthy();
  });
