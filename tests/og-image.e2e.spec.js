...
test.describe('OpenGraph Image Validation', () => {
  const ogImagePath = path.join(process.cwd(), 'src', 'img', 'elementos-UXUI', 'og-share.png');

  test('og-share.png should exist', async () => {
    expect(fs.existsSync(ogImagePath), 'El archivo src/img/elementos-UXUI/og-share.png no existe').toBeTruthy();
  });
