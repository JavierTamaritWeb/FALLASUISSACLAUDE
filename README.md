...
🆕 Última actualización: 16 de septiembre de 2026 - v4.41.4 - **Fix**: la notificación de la barra móvil ya no se solapa con los botones ni el menú, tampoco con textos largos (se recorta con «…»); `header-mobile-layout` pasa y entra en la smoke.
