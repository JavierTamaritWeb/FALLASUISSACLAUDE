...
Este archivo se mantiene solo como alias histórico para no romper enlaces antiguos.

## Guía vigente

La documentación actual del tablón está en:

- [`gestion-tablon.md`](./gestion-tablon.md)
...
**Versión:** alias histórico; referencia operativa vigente en `gestion-tablon.md` (v4.6.18)
