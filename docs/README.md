...
- La versión funcional documentada del proyecto es `v4.15.2` y `package.json`/`package-lock.json` ya están sincronizados con esa release.
...
*Última actualización: 9 de septiembre de 2026 - v4.15.2*
