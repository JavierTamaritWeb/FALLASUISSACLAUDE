...
- La versión funcional documentada del proyecto es `v4.22.7` y `package.json`/`package-lock.json` ya están sincronizados con esa release.
...
*Última actualización: 10 de septiembre de 2026 - v4.22.7*
