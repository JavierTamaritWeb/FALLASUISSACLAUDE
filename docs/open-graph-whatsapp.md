...
- Archivo fuente de salida: `src/img/elementos-UXUI/og-share.png`
...
Esto ejecuta `scripts/generate-og-image.mjs` y regenera `src/img/elementos-UXUI/og-share.png`.
...
- Antes: `https://fallasuissa.es/img/elementos-UXUI/og-share.png`
- Ahora: `https://fallasuissa.es/img/elementos-UXUI/og-share.png?v=20260122`
...
- Que existe `src/img/elementos-UXUI/og-share.png`
