...
`src/.htaccess` declara 10 reglas (A-J; E = 410 de base.html) dentro del bloque `<IfModule mod_rewrite.c>`, **después** de la redirección `www → no-www` y **antes** de la negociación de Markdown:
...
# I) Imagen del banner de subvención → /img/subvenciones/subvencion-2026.* (v4.30.11)
