...
**Síntoma:** en modo oscuro, el icono del calendario de `eventos.html` (`img/elementos-UXUI/calendario.png`, con transparencia) aparecía dentro de una caja blanca redondeada. El PNG y sus AVIF/WebP tienen alfa correcto; ninguna regla del componente pone fondo.
