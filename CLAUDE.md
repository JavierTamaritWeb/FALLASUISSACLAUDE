...
- `src/` — **Todos los archivos fuente**:
  ...
  - `src/data/` — JSON: `translations.json`, `board.json`, `sports-board.json`, `eventos.json`, `calendarData.json`, `fallas.json`, `config.json`, `dataPages[1-6].json` (`blog.json` eliminado en v4.6.0)
