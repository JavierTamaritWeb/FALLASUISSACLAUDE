...
const inputPath = path.join(__dirname, '../src/img/escudo-falla/Escudo-Oficial-Falla.png');
const outputPath = path.join(__dirname, '../src/img/elementos-UXUI/og-share.png');
